...
app.get('/api/get-products', (req, res, next)=>{
  res.send({
    products: [
    {
      ...
      images: [
        "./server/images/product_images/Mariposa/Mariposa_1.webp",
        "./server/images/product_images/Mariposa/Mariposa_2.webp",
        "./server/images/product_images/Mariposa/Mariposa_3.jpg",
        "./server/images/product_images/Mariposa/Mariposa_4.jpg"
      ],
      features: [
    ...
    },
    {
      ...
      images: [
        "./server/images/product_images/CDT/cdt_1.jpg",
        "./server/images/product_images/CDT/cdt_2.jpg",
        "./server/images/product_images/CDT/cdt_3.jpg",
        "./server/images/product_images/CDT/cdt_4.jpg"
      ],
      features: [
    ...
    },
    {
      ...
      images: [
        "./server/images/product_images/Windrider/HMG_Windrider_1.jpg",
        "./server/images/product_images/Windrider/HMG_Windrider_2.jpg",
        "./server/images/product_images/Windrider/HMG_Windrider_3.jpg",
        "./server/images/product_images/Windrider/HMG_Windrider_4.jpg"
      ],
      features: [
        "Made in Maine",
    ...
    },
    {
      ...
      images: [
        "./server/images/product_images/Levity/levity_1.jpg",
        "./server/images/product_images/Levity/levity_2.jpg",
        "./server/images/product_images/Levity/levity_3.jpg",
        "./server/images/product_images/Levity/levity_4.jpg"
      ],
      features: [
